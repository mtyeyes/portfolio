(function () {
  ...
  var controls = [
    {
      check: function () {
        return (
          pressedKeys.indexOf('ArrowRight') !== -1 &&
          pressedKeys.indexOf('ControlLeft') !== -1
        );
      },
      result: function () {
        changeCoordinates('horizontal', 10);
      }
    },
    {
      check: function () {
        return pressedKeys.indexOf('ArrowRight') !== -1;
      },
      result: function () {
        changeCoordinates('horizontal', 1);
      }
    },
    {
      check: function () {
        return (
          pressedKeys.indexOf('ArrowLeft') !== -1 &&
          pressedKeys.indexOf('ControlLeft') !== -1
        );
      },
      result: function () {
    ...
    {
      check: function () {
        return pressedKeys.indexOf('ArrowLeft') !== -1;
      },
      result: function () {
        changeCoordinates('horizontal', -1);
      }
    },
    {
      check: function () {
        return (
          pressedKeys.indexOf('ArrowUp') !== -1 &&
          pressedKeys.indexOf('ControlLeft') !== -1
        );
      },
      result: function () {
        changeCoordinates('vertical', -10);
      }
    },
    {
      check: function () {
        return pressedKeys.indexOf('ArrowUp') !== -1;
      },
      result: function () {
        changeCoordinates('vertical', -1);
      }
    },
    {
      check: function () {
        return (
          pressedKeys.indexOf('ArrowDown') !== -1 &&
          pressedKeys.indexOf('ControlLeft') !== -1
        );
      },
      result: function () {
    ...
    {
      check: function () {
        return pressedKeys.indexOf('ArrowDown') !== -1;
      },
      result: function () {
        changeCoordinates('vertical', 1);
      }
    ...
    {
      check: function () {
        return pressedKeys.indexOf('Comma') !== -1;
      },
      result: function () {
        changeOpacity(-1);
      }
    ...
    {
      check: function () {
        return pressedKeys.indexOf('Period') !== -1;
      },
      result: function () {
        changeOpacity(1);
      }
    ...
    {
      check: function () {
        return pressedKeys.indexOf('PageUp') !== -1;
      },
      result: function () {
        changeOverlaySrc('previous');
      }
    },
    {
      check: function () {
        return pressedKeys.indexOf('PageDown') !== -1;
      },
      result: function () {
        changeOverlaySrc('next');
      }
    },
    {
      check: function () {
        return pressedKeys.indexOf('Home') !== -1;
      },
      result: function () {
        resetCoordinates();
      }
    ...
    {
      check: function () {
        return pressedKeys.indexOf('Backquote') !== -1;
      },
      result: function () {
        toggleDisplay();
      }
    ...
    {
      check: function () {
        return pressedKeys.indexOf('Slash') !== -1;
      },
      result: function () {
        toggleHelp();
      }
    ...
    {
      check: function () {
        return pressedKeys.indexOf('Delete') !== -1;
      },
      result: function () {
        clearLocalStorage();
      }
  ...
  function styleElements(list) {
    for (var element in list) {
      ...
      for (var property in list[element]) {
        stylesToApply =
          stylesToApply + property + ':' + list[element][property] + ';';
      }
  ...
  (function () {
    ...
    if (localStorage.getItem('overlaynumber')) {
      overlay.src =
        './overlays/overlay' + localStorage.getItem('overlaynumber');
    ...
    overlayHelp.innerHTML =
      '<br>Arrows – Move overlay</br><br>Ctrl + arrows – Wide steps</br><br>PageUp/PageDown – Previous/Next overlay</br><br>Comma/Period – Change overlay opacity</br><br>Home – Reset overlay position</br><br>Backquote – Show/Hide overlay</br><br>Delete – Clear local storage</br>';
  ...
  function showOverlayInformation() {
    ...
    overlayInformation.innerHTML =
      '<br>Horizontal offset: ' +
      overlay.style.left +
      '</br><br>Vertical offset: ' +
      overlay.style.top +
      '</br><br>Overlay opacity: ' +
      (overlay.style.opacity * 100 + '%') +
      '</br><br>Overlay number: ' +
      overlaySrc +
      '</br>';
  ...
  function changeCoordinates(axis, step) {
    if (axis === 'vertical') {
      overlay.style.top =
        +overlay.style.top.slice(0, -2) + parseInt(step, 10) + 'px';
      localStorage.setItem('vertical', overlay.style.top);
    } else {
      overlay.style.left =
        +overlay.style.left.slice(0, -2) + parseInt(step, 10) + 'px';
