...
},{"core-js/shim":"../node_modules/core-js/shim.js","regenerator-runtime/runtime":"../node_modules/regenerator-runtime/runtime.js","core-js/fn/regexp/escape":"../node_modules/core-js/fn/regexp/escape.js"}],"js/animate-when-in-viewport.js":[function(require,module,exports) {
if ('IntersectionObserver' in window && 'IntersectionObserverEntry' in window && 'intersectionRatio' in window.IntersectionObserverEntry.prototype) {
  var animatedElements = document.querySelectorAll('.fade-in-up');
  var animatedPseudoElements = document.querySelectorAll('.animated-pseudo-element');
  ...
  for (var _i = 0; _i < animatedPseudoElements.length; _i++) {
    animatedPseudoElements[_i].classList.remove('animated-pseudo-element');

    animatedPseudoElements[_i].classList.add('hide-pseudo-element');

    observer.observe(animatedPseudoElements[_i]);
  }
}
},{}],"js/custom-alert.js":[function(require,module,exports) {
"use strict";
...
var modalText = document.querySelector('.modal-alert__text');
...
},{}],"js/blank-links.js":[function(require,module,exports) {
"use strict";

var _customAlert = require("./custom-alert.js");
...
try {
  for (var _iterator = links[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
    ...
    link.addEventListener('click', function (event) {
      ...
      (0, _customAlert.show)('For now, only this page is available');
    });
  }
} catch (err) {
...
;
},{"./custom-alert.js":"js/custom-alert.js"}],"js/carousel.js":[function(require,module,exports) {
var carouselCore = {
  getScrollDirection: function getScrollDirection(event) {
    if (event.deltaY < 0) {
      return 'right';
    } else {
      return 'left';
  ...
  scrollHandler: function scrollHandler(event, block) {
  ...
  adjust: function adjust(block) {
    var itemWidth;
    var marginBetweenItems = +window.getComputedStyle(block['items'][0])['margin-right'].replace('px', '');
    ...
    if (block['resizeToFill']) {
      ...
      try {
        for (var _iterator = block['items'][Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
    ...
    if (block['resizeToFill']) {
      block['list'].style.width = (itemWidth + marginBetweenItems) * block['items'].length - marginBetweenItems + 'px';
    }

    block['list'].style.transform = 'translateX(' + block['currentItem'] * block['stepWidth'] * -1 + 'px)';

    if (block['radioBtns']) {
      this.whichRadioBtnChecked(block);
    }

    ;
  },
  adjustRadioBtns: function adjustRadioBtns(block) {
    var numberOfBtns = Math.ceil(block['items'].length / block.itemsVisible());

    if (numberOfBtns === block['radioBtns'].length) {
      return;
    } else {
      block['radioBtnsContainer'].innerHTML = '';
    }
    ...
    var labelsArr = document.querySelectorAll('.' + block['name'] + '__label');

    var _loop = function _loop(_i) {
      block['radioBtns'][_i].addEventListener('input', function (event) {
        var position;
        _i !== labelsArr.length - 1 ? position = _i * block.itemsVisible() : position = block['items'].length - block.itemsVisible();
        carouselCore.slideTo(block, position);
        block['radioBtns'][_i].checked = true;
      });
    };

    for (var _i = 0; _i < labelsArr.length; _i++) {
      _loop(_i);
    }
  },
  whichRadioBtnChecked: function whichRadioBtnChecked(block) {
    var itemsVisible = block.itemsVisible();

    for (var i = 0; i < block['radioBtns'].length; i++) {
      if (block['currentItem'] <= itemsVisible * (i + 1) - 1 && block['currentItem'] > itemsVisible * i - 1) {
    ...
    if (block['currentItem'] + 1 >= itemsVisible * Math.floor(block['items'].length / itemsVisible)) {
      block['radioBtns'][block['radioBtns'].length - 1].checked = true;
    }

    ;
  },
  slideStoppedAtEdge: function slideStoppedAtEdge(block, direction) {
    block['freeze'] = true;
    ...
    try {
      for (var _iterator2 = block['items'][Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
    ...
    block['items'][1].addEventListener('animationend', function (event) {
      ...
      try {
        for (var _iterator3 = block['items'][Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
  ...
  slideBeyond: function slideBeyond(block, direction) {
    block['freeze'] = true;
    ...
    try {
      for (var _iterator4 = block['items'][Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
    ...
    block['items'][1].addEventListener('animationend', function (event) {
      ...
      try {
        for (var _iterator5 = block['items'][Symbol.iterator](), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
  ...
  slide: function slide(block, direction) {
  ...
  slideTo: function slideTo(block, position) {
    block['currentItem'] = position;
    this.adjust(block);
  },
  swipe: function swipe(newPointerCoordinatesX) {
    var block = this.swipeInformation.calledFrom;

    if (!block) {
      return;
    }

    var pointerPath = newPointerCoordinatesX - this.swipeInformation.x;
...
var staffCarousel = {
  ...
  'stopAtEdge': true,
  'resizeToFill': false,
  itemsVisible: function itemsVisible() {
  ...
  refreshRadioBtns: function refreshRadioBtns() {
...
var carouselsArr = [staffCarousel, reviewsCarousel, galleryCarousel];
window.addEventListener('resize', function (event) {
  ...
  try {
    for (var _iterator6 = carouselsArr[Symbol.iterator](), _step6; !(_iteratorNormalCompletion6 = (_step6 = _iterator6.next()).done); _iteratorNormalCompletion6 = true) {
      ...
      if (typeof obj['radioBtns'] !== 'undefined' && obj['items'].length > obj.itemsVisible()) {
        carouselCore.adjustRadioBtns(obj);
      }
...
var _loop2 = function _loop2() {
  ...
  obj['container'].addEventListener('mousedown', function (event) {
    ...
    carouselCore.longPress = setTimeout(function () {
      carouselCore['swipeInformation'] = {};
    }, 2500);
  });
...
for (var _i2 = 0, _carouselsArr = carouselsArr; _i2 < _carouselsArr.length; _i2++) {
  _loop2();
}
...
var copyImgsToCarousel = function copyImgsToCarousel() {
  var list = document.createDocumentFragment();

  for (var i = 0; i < galleryCarousel['items'].length; i++) {
    var galeryImg = galleryCarousel['items'][i].querySelector('img');
    var imgWrapper = document.createElement('li');
...
var copyImgsToThumbnails = function copyImgsToThumbnails() {
  var list = document.createDocumentFragment();

  for (var i = 0; i < galleryCarousel['items'].length; i++) {
    var elementToCopy = void 0;
    var _iteratorNormalCompletion7 = true;
    var _didIteratorError7 = false;
    var _iteratorError7 = undefined;

    try {
      for (var _iterator7 = galleryCarousel['items'][Symbol.iterator](), _step7; !(_iteratorNormalCompletion7 = (_step7 = _iterator7.next()).done); _iteratorNormalCompletion7 = true) {
    ...
    var newElement = elementToCopy.cloneNode(true);
  ...
  try {
    for (var _iterator8 = modalGalleryCarousel['thumbnails'][Symbol.iterator](), _step8; !(_iteratorNormalCompletion8 = (_step8 = _iterator8.next()).done); _iteratorNormalCompletion8 = true) {
...
var recalcMargin = function recalcMargin() {
  var _iteratorNormalCompletion9 = true;
  var _didIteratorError9 = false;
  var _iteratorError9 = undefined;

  try {
    for (var _iterator9 = modalGalleryCarousel['items'][Symbol.iterator](), _step9; !(_iteratorNormalCompletion9 = (_step9 = _iterator9.next()).done); _iteratorNormalCompletion9 = true) {
...
var fillModalGallery = function fillModalGallery(event) {
  copyImgsToCarousel();
  copyImgsToThumbnails();
  modalGalleryCarousel['filled'] = true;
};

var slideToSelected = function slideToSelected(element) {
  for (var i = 0; i < modalGalleryCarousel['items'].length; i++) {
...
var synchronizeModalCarousel = function synchronizeModalCarousel() {
  for (var i = 0; i < modalGalleryCarousel['items'].length; i++) {
...
var showModalGallery = function showModalGallery(event) {
...
var chooseImgOnThumbnail = function chooseImgOnThumbnail(element) {
  if (element.classList.contains('modal-gallery__thumbnail--selected')) {
    return;
  }

  var selectedImg = element.dataset.id;
...
var setEventListeners = function setEventListeners() {
  ...
  modalGalleryCarousel['container'].addEventListener('mousedown', function (event) {
    var eventInformation = {
      x: event.screenX,
      calledFrom: modalGalleryCarousel
    };
    carouselCore['swipeInformation'] = eventInformation;
    carouselCore.longPress = setTimeout(function () {
      carouselCore['swipeInformation'] = {};
...
try {
  for (var _iterator10 = galleryCarousel['items'][Symbol.iterator](), _step10; !(_iteratorNormalCompletion10 = (_step10 = _iterator10.next()).done); _iteratorNormalCompletion10 = true) {
...
;
},{}],"js/form-validation.js":[function(require,module,exports) {
"use strict";

var _customAlert = require("./custom-alert.js");

var inputsArray = document.querySelectorAll('.form__input');
...
submitBtn.addEventListener('click', function (event) {
  ...
  try {
    for (var _iterator2 = inputsArray[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
      var input = _step2.value;

      if (input.required === true) {
        if (!input.checkValidity()) {
          (0, _customAlert.show)('Form is not filled correctly');
          var _iteratorNormalCompletion4 = true;
          var _didIteratorError4 = false;
          var _iteratorError4 = undefined;

          try {
            for (var _iterator4 = inputsArray[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
              var _input = _step4.value;

              _input.classList.add('form__input--changed');
            }
          } catch (err) {
            _didIteratorError4 = true;
            _iteratorError4 = err;
  ...
  (0, _customAlert.show)('We will contact you as soon as possible!');
  var _iteratorNormalCompletion3 = true;
  var _didIteratorError3 = false;
  var _iteratorError3 = undefined;

  try {
    for (var _iterator3 = inputsArray[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
...
},{"./custom-alert.js":"js/custom-alert.js"}],"js/map-load-on-page-load.js":[function(require,module,exports) {
var loadMap = function loadMap() {
  var googleMap = document.createElement("script");
  googleMap.innerHTML = 'function initMap(){var e=new google.maps.Geocoder;!function(e,l){e.geocode({address:"1401 W 6th St, Los Angeles, CA 90017, USA"},function(e,t){if("OK"===t){l.setCenter(e[0].geometry.location);new google.maps.Marker({map:l,position:e[0].geometry.location})}})}(e,new google.maps.Map(document.querySelector(".map__interactive"),{center:{lat:34.056,lng:-118.267},zoom:15,disableDefaultUI:!0,styles:[{elementType:"geometry",stylers:[{color:"#212121"}]},{elementType:"labels",stylers:[{color:"#666666"},{weight:.5}]},{elementType:"labels.icon",stylers:[{visibility:"off"}]},{elementType:"labels.text",stylers:[{color:"#666666"}]},{elementType:"labels.text.fill",stylers:[{color:"#666666"}]},{elementType:"labels.text.stroke",stylers:[{color:"#212121"}]},{featureType:"administrative",elementType:"geometry",stylers:[{color:"#757575"}]},{featureType:"administrative.country",elementType:"labels.text.fill",stylers:[{color:"#9e9e9e"}]},{featureType:"administrative.land_parcel",stylers:[{visibility:"off"}]},{featureType:"administrative.locality",elementType:"labels.text.fill",stylers:[{color:"#bdbdbd"}]},{featureType:"landscape.man_made",elementType:"geometry.fill",stylers:[{color:"#212121"}]},{featureType:"poi",elementType:"labels.text.fill",stylers:[{color:"#757575"}]},{featureType:"poi.park",elementType:"geometry",stylers:[{color:"#181818"}]},{featureType:"poi.park",elementType:"labels.text.fill",stylers:[{color:"#616161"}]},{featureType:"poi.park",elementType:"labels.text.stroke",stylers:[{color:"#1b1b1b"}]},{featureType:"road",elementType:"geometry.fill",stylers:[{color:"#2e2e2e"}]},{featureType:"road",elementType:"labels",stylers:[{color:"#666666"}]},{featureType:"road",elementType:"labels.text.fill",stylers:[{color:"#8a8a8a"}]},{featureType:"road.arterial",elementType:"geometry",stylers:[{color:"#373737"}]},{featureType:"road.arterial",elementType:"geometry.fill",stylers:[{color:"#2e2e2e"}]},{featureType:"road.highway",elementType:"geometry",stylers:[{color:"#3c3c3c"}]},{featureType:"road.highway",elementType:"geometry.fill",stylers:[{color:"#2e2e2e"}]},{featureType:"road.highway.controlled_access",elementType:"geometry",stylers:[{color:"#4e4e4e"}]},{featureType:"road.highway.controlled_access",elementType:"geometry.fill",stylers:[{color:"#2e2e2e"}]},{featureType:"road.local",elementType:"geometry.fill",stylers:[{color:"#2e2e2e"}]},{featureType:"road.local",elementType:"labels.text.fill",stylers:[{color:"#616161"}]},{featureType:"transit",elementType:"labels.text.fill",stylers:[{color:"#757575"}]},{featureType:"water",elementType:"geometry",stylers:[{color:"#000000"}]},{featureType:"water",elementType:"labels.text.fill",stylers:[{color:"#3d3d3d"}]}]}))}!function(){var e=document.createElement("script"),l=["XNEbnRKOTVNZXUzVFB","uZFVHeFgteHJRSHpJbUJR","QUl6YVN5RDhhL"];e.src="https://maps.googleapis.com/maps/api/js?key="+window.atob(l[2]+l[0]+l[1])+"&callback=initMap",e.type="text/javascript",document.body.appendChild(e)}();';
...
},{}],"js/menu-toggle.js":[function(require,module,exports) {
...
;
},{}],"js/no-js.js":[function(require,module,exports) {
var classNames = ['no-js--remove'];

for (var _i = 0, _classNames = classNames; _i < _classNames.length; _i++) {
  var className = _classNames[_i];
  var arrayOfElements = document.querySelectorAll('.' + className);
  var _iteratorNormalCompletion = true;
  var _didIteratorError = false;
  var _iteratorError = undefined;
...
;
},{}],"js/on-scroll.js":[function(require,module,exports) {
var header = document.querySelector('.header');
var scrollToTopBtn = document.querySelector('.scroll-to-top');
var imageContainer = document.querySelector('.about__pictures-container');
var imageLeft = document.querySelector('.about__img--left');
var imageRight = document.querySelector('.about__img--right');

var parallax = function parallax() {
  var maxOffset = 15;
  var parallaxSpread = 2 * imageContainer.clientHeight;
  var parallaxStart = 1.8 * imageContainer.clientHeight;
  var scrollDistance = imageContainer.getBoundingClientRect()['y'] || imageContainer.getBoundingClientRect()['top'];
  var progress = (parallaxStart - scrollDistance) / parallaxSpread;
  var yOffset;
...
var animateWhenInViewport = require('./animate-when-in-viewport.js');

var blankLinks = require('./blank-links.js');

var carousel = require('./carousel.js');

var formValidation = require('./form-validation.js');

var mapLoadOnPageLoad = require('./map-load-on-page-load.js');

var menuToggle = require('./menu-toggle.js');

var noJs = require('./no-js.js');

var onScroll = require('./on-scroll.js');
},{"babel-polyfill":"../node_modules/babel-polyfill/lib/index.js","./animate-when-in-viewport.js":"js/animate-when-in-viewport.js","./blank-links.js":"js/blank-links.js","./carousel.js":"js/carousel.js","./form-validation.js":"js/form-validation.js","./map-load-on-page-load.js":"js/map-load-on-page-load.js","./menu-toggle.js":"js/menu-toggle.js","./no-js.js":"js/no-js.js","./on-scroll.js":"js/on-scroll.js"}],"C:/Users/mtyey/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["C:/Users/mtyey/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","js/index.js"], null)
